...
backbone.load_state_dict(torch.load(conf_dict['paths']['backbone_path'],weights_only=True,map_location=device)['model_state_dict'])
...
checkpoint_path='checkpoints/b3_group_classifier_best_model_checkpoint.pth'
train(model,criterion,optimizer,scheduler,train_loader,val_loader,n_epoch,device,checkpoint_path,ind_step=100,early_stop=3,n_frozen_layers=7)
